...
if(isset($_POST["btn_update"]))
{
	...
	if($_FILES['image']['name']!=''){
		...
		$file_tem_loc = $_FILES['image']['temp_name'];
										...
										<form id="main" method ="post" enctype="multipart/form-data">
											...
											<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-sm-4">
														<input type="tel" class="form-control" id="contact" name="contact" value="<?php echo $contact;?>" placeholder = "Enter valid contact number: " minlength="11" maxlength="13" pattern ="[0-9]{4}-[0-9]{3}-[0-9]{4}">
														<span class="messages"></span>
													</div>
