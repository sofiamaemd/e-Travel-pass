...
<head>
	...
	<title>Online Travel e-Pass | sign up</title>
	...
	<meta name="author" content="sofiamaemmd">
						...
						<div class="card-block">
							<form id="main" method="post" action="save_user.php" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group form-primary">
											<input type="text" class="form-control mob_no" data-mask="9999-999-9999" name="contact" placeholder="Phone Number" required="">
											<span class="form-bar"></span>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group form-primary">
											<input type="text" class="form-control" name="company" placeholder="Companion" required="">
											<span class="form-bar"></span>
										</div>
									</div>
									<div class="col-sm-6">
									...
									<div class="col-md-12">
										<div class="checkbox-fade fade-in-primary">
											<label>
												...
												<span class="text-inverse">I accept your terms & conditions</span>
											</label>
										</div>
									</div>
								</div>
