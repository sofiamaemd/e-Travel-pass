...
<script src = "https://cdn.ckeditor.com/4.12.1/standard/ckeditor.js"></script>php
								...
								<div class="card-block">
									<form id="main" method="post" action="save_user.php" enctype="multipart/form-data">
										...
										<div class="form-group row">
											...
											<div class="col-sm-4">
												<input type="tel" class="form-control" id="contact" placeholder="Enter valid phone number..." minlength="11" maxlength="13" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" required="">
												<span class="messages"></span>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-4">
												<input type="date" class="form-control" name="dob" placeholder="Enter last name..." required="">
												<span class="messages"></span>
											</div>
