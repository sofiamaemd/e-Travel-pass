	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			...
			<div class="col-md-7 align-self-center">
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="javasript:void(0)">Home</a></li>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="r\col-lg-8" style="margin-left: 10%;">
					<div class="card">
						...
						<div class="card-body">
							<div class="input-states">
								<form class="form-horizontal" method="POST">
									...
									<button type="submit" name="btn_email" class="btn btn-primary btn-flat m-b-30 m-t-30">Update</button>
								</form>
							</div>
						</div>
					</div>
