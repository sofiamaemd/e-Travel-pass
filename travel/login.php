...
<body class = "fix-menu">
	<noscript><iframe src = "https://www.googletagmanager.com/ns.html?id=GTM-T9PCZX9" height = "0" width="0" style="display: none; visibility:hidden"> </iframe></noscript>
...
?>
	...
	if(isset($_POST['btn_check']))
	{
		...
		$sql1 = "SELECT * FROM `tbl_repairs` where delete_status = 0";
