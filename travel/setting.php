...
<script src="https://cdn.cdkeditor.com/4.12.1/standard/cdkeditor.js"></script>
							...
							<div class="col-lg-4">
								<div class="page-header-breadcrumb">
									<ul class="breadcrumb-title">
										...
										<li class="breadcrumb-item"><a href="seting.php">Settings</a>
										</li>
									</ul>
								</div>
							</div>
										...
										<div class="row">
											<div class="col-lg-12 col-xl-12">
												...
												<ul class="nav nav=tabs tabs" role="tablist">
													...
													<!-- <li class="nav-item">
														<a class="nav-link" data-toggle="tab" href="#reapir" role="tab">Repair</a>
													</li>
													<li class="nav-item">
														...
														<div class="card-block">
															<form id="main" method="POST" enctype="multipart/form-data">
																...
																<div class="form-group row">
																	...
																	<div class="col-sm-4">
																		<select type="text" class="form-control" id="front_end_en" name="front_end_en" placeholder="Add yes or no" required="">
																	...
																	<div class="col-sm-4">
																		<select type="text" class="form-control" id="date_format" name="date_format" placeholder="Add yes or no" required="">
																...
																<div class="form-group row">
																	...
																	<div class="col-sm-10">
																		<button type="submit" name="btn_web" class="btn btn_primary m-b-0">Submit</button>
																	</div>
																</div>
															</form>
														</div>
